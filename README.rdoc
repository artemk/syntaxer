...
To install syntaxer run
  ...
  For now only works with ruby 1.9.2
...
It create config/syntaxer.rb file with common rails options, you may edit it as you wish.

And create .git/hooks/pre-commit script, it will be check syntax of
created and updated files before every commit.
